...
public final class Args {
    ...
    public static void requireDimensionMatch(double[] arr1, String arr1Name, double[] arr2, String arr2Name) {
        if(arr1.length != arr2.length) {
            throw new DimensionMismatchException(String.format("Dimension mismatch between %s (%d) and %s (%d)",
                    arr1Name, arr1.length,
                    arr2Name, arr2.length));
        }
    }
}
